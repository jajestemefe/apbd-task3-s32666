...
public sealed class LinqExercises
{
    ...
    public IEnumerable<string> Task13_GroupEnrollmentsByCourse()
    {
        ...
        return UniversityData.Enrollments.GroupBy(e => e.CourseId).
            Join(UniversityData.Courses, g => 
            g.Key, c => c.Id, (g, c) =>
                $"{c.Title} {g.Count()}").ToList();
    }
    ...
    public IEnumerable<string> Task14_AverageGradePerCourse()
    {
        ...
        return UniversityData.Enrollments.Where(e => e.FinalGrade != null).
            GroupBy(e => e.CourseId).Join(UniversityData.Courses, g =>
            g.Key, c => c.Id, (g, c) =>
            $"{c.Title} {g.Average(e => e.FinalGrade)}").ToList();
    }
    ...
    public IEnumerable<string> Task15_LecturersAndCourseCounts()
    {
        ...
        return UniversityData.Lecturers
            .Select(l => $"{l.FirstName} {l.LastName} - {UniversityData.Courses.
                Count(c => c.LecturerId == l.Id)}").ToList();
    }
    ...
    public IEnumerable<string> Task16_HighestGradePerStudent()
    {
        ...
        return UniversityData.Enrollments
            ...
            .Join(UniversityData.Students, g =>
                g.Key, s => s.Id, (g, s) =>
                $"{s.FirstName} {s.LastName} {g.Max(e => e.FinalGrade)}").ToList();
    }
